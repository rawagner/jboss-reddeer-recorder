...
public class DropDownClassAnnotationSelectionListener extends SelectionAdapter {
	...
	public DropDownClassAnnotationSelectionListener(ToolItem dropdown, BotGeneratorEventDispatcher recorder, Map<CTabItem, SourceViewer> tabViewer, CTabFolder classTabFolder) {
	...
	public void addItems(List<AnnotationRule> items) {
		...
		if(items != null){
			...
			if(!classAnnotations.isEmpty()){
				for (AnnotationRule item : classAnnotations) {
